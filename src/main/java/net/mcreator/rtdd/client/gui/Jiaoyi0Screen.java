...
import net.mcreator.rtdd.network.Jiaoyi0ButtonMessage;
...
public class Jiaoyi0Screen extends AbstractContainerScreen<Jiaoyi0Menu> {
	private final static HashMap<String, Object> guistate = Jiaoyi0Menu.guistate;
	...
	public Jiaoyi0Screen(Jiaoyi0Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("rtdd:textures/screens/jiaoyi_0.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("rtdd:textures/screens/npcjiao_yi_.png"));
	...
	public void init() {
		...
		imagebutton_biao_ji_2 = new ImageButton(this.leftPos + -43, this.topPos + 20, 19, 18, 0, 0, 18, new ResourceLocation("rtdd:textures/screens/atlas/imagebutton_biao_ji_2.png"), 19, 36, e -> {
			if (true) {
				RtddMod.PACKET_HANDLER.sendToServer(new Jiaoyi0ButtonMessage(0, x, y, z));
				Jiaoyi0ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_biao_ji_21 = new ImageButton(this.leftPos + -43, this.topPos + 46, 19, 18, 0, 0, 18, new ResourceLocation("rtdd:textures/screens/atlas/imagebutton_biao_ji_21.png"), 19, 36, e -> {
			if (true) {
				RtddMod.PACKET_HANDLER.sendToServer(new Jiaoyi0ButtonMessage(1, x, y, z));
				Jiaoyi0ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_biao_ji_22 = new ImageButton(this.leftPos + -43, this.topPos + 124, 19, 18, 0, 0, 18, new ResourceLocation("rtdd:textures/screens/atlas/imagebutton_biao_ji_22.png"), 19, 36, e -> {
			if (true) {
				RtddMod.PACKET_HANDLER.sendToServer(new Jiaoyi0ButtonMessage(2, x, y, z));
				Jiaoyi0ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_biao_ji_23 = new ImageButton(this.leftPos + -43, this.topPos + 72, 19, 18, 0, 0, 18, new ResourceLocation("rtdd:textures/screens/atlas/imagebutton_biao_ji_23.png"), 19, 36, e -> {
			if (true) {
				RtddMod.PACKET_HANDLER.sendToServer(new Jiaoyi0ButtonMessage(3, x, y, z));
				Jiaoyi0ButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_biao_ji_24 = new ImageButton(this.leftPos + -43, this.topPos + 98, 19, 18, 0, 0, 18, new ResourceLocation("rtdd:textures/screens/atlas/imagebutton_biao_ji_24.png"), 19, 36, e -> {
			if (true) {
				RtddMod.PACKET_HANDLER.sendToServer(new Jiaoyi0ButtonMessage(4, x, y, z));
				Jiaoyi0ButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_biao_ji_25 = new ImageButton(this.leftPos + -43, this.topPos + 149, 19, 18, 0, 0, 18, new ResourceLocation("rtdd:textures/screens/atlas/imagebutton_biao_ji_25.png"), 19, 36, e -> {
			if (true) {
				RtddMod.PACKET_HANDLER.sendToServer(new Jiaoyi0ButtonMessage(5, x, y, z));
				Jiaoyi0ButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
