...
public class Yigui5Screen extends AbstractContainerScreen<Yigui5Menu> {
	private final static HashMap<String, Object> guistate = Yigui5Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public Yigui5Screen(Yigui5Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("rtdd:textures/screens/yigui_5.png");
