		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == RtddModItems.CLEAVER.get()) {
			{
				...
				BlockState _bs = RtddModBlocks.COW_2.get().defaultBlockState();
			...
			if (world instanceof Level _level && !_level.isClientSide()) {
				ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), new ItemStack(RtddModItems.LEGCOW.get()));
