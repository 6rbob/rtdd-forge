...
public class ZHULANMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ZHULANMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RtddModMenus.ZHULAN, id);
