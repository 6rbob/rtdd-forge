...
public class Zhulan2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Zhulan2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RtddModMenus.ZHULAN_2, id);
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 106, 44) {
		}));
