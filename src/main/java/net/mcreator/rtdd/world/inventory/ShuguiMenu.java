...
public class ShuguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ShuguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RtddModMenus.SHUGUI, id);
		...
		this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 61, 62) {
			@Override
			public boolean mayPickup(Player entity) {
				return false;
			}
