...
public class G112Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public G112Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RtddModMenus.G_112, id);
