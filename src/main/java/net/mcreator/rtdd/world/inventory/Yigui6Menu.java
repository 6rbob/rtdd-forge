...
public class Yigui6Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Yigui6Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RtddModMenus.YIGUI_6, id);
		...
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 133, 44) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return stack.is(ItemTags.create(new ResourceLocation("t_4")));
			}
