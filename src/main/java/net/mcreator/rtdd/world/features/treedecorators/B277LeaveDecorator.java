...
public class B277LeaveDecorator extends LeaveVineDecorator {
	public static final B277LeaveDecorator INSTANCE = new B277LeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("b_277_tree_leave_decorator");
	...
	private static void addVine(LevelSimulatedReader levelReader, BlockPos blockPos, BiConsumer<BlockPos, BlockState> biConsumer) {
		biConsumer.accept(blockPos, RtddModBlocks.D_75.get().defaultBlockState());
		int i = 4;
