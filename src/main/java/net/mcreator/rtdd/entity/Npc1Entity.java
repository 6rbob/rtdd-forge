...
package net.mcreator.rtdd.entity;
...
public class Npc1Entity extends Monster {
	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(RtddModEntities.NPC_1.get(), 20, 4, 4));
	}

	public Npc1Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(RtddModEntities.NPC_1.get(), world);
	}

	public Npc1Entity(EntityType<Npc1Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(23, new NearestAttackableTargetGoal(this, Player.class, false, false));
	}
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(Npc1Entity.this.getId());
					return new Jiao4Menu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public static void init() {
		SpawnPlacements.register(RtddModEntities.NPC_1.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
