...
public class B281Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.B_281.get(), renderType -> renderType == RenderType.cutout());
	}
}
