...
public class D24Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_24.get(), renderType -> renderType == RenderType.cutout());
	}
}
