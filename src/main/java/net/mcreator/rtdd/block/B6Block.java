...
import net.mcreator.rtdd.procedures.BoxworkProcedure;
import net.mcreator.rtdd.init.RtddModBlocks;

import java.util.List;
import java.util.Collections;

public class B6Block extends Block {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		BoxworkProcedure.execute(world, x, y, z, entity);
		return InteractionResult.SUCCESS;
	}

	@OnlyIn(Dist.CLIENT)
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.B_6.get(), renderType -> renderType == RenderType.cutout());
	}
}
