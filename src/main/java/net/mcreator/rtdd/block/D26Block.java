...
public class D26Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_26.get(), renderType -> renderType == RenderType.cutout());
	}
}
