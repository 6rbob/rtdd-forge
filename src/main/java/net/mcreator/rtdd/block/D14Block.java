...
public class D14Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_14.get(), renderType -> renderType == RenderType.cutout());
	}
}
