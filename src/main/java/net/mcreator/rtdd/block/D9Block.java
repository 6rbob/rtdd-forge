...
public class D9Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_9.get(), renderType -> renderType == RenderType.cutout());
	}
}
