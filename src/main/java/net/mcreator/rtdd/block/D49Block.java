...
public class D49Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_49.get(), renderType -> renderType == RenderType.cutout());
	}
}
