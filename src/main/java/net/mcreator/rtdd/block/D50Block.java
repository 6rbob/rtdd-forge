...
public class D50Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_50.get(), renderType -> renderType == RenderType.cutout());
	}
}
