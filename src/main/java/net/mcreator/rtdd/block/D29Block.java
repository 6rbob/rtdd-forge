...
public class D29Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_29.get(), renderType -> renderType == RenderType.cutout());
	}
}
