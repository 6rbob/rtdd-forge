...
public class D23Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_23.get(), renderType -> renderType == RenderType.cutout());
	}
}
