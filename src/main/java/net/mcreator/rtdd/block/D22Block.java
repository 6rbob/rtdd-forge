...
public class D22Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_22.get(), renderType -> renderType == RenderType.cutout());
	}
}
