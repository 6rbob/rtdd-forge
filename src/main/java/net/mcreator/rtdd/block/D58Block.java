...
public class D58Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_58.get(), renderType -> renderType == RenderType.cutout());
	}
}
