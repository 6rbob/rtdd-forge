...
public class D17Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_17.get(), renderType -> renderType == RenderType.cutout());
	}
}
