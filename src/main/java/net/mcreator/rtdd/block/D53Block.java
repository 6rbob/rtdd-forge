...
public class D53Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_53.get(), renderType -> renderType == RenderType.cutout());
	}
}
