...
public class D57Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_57.get(), renderType -> renderType == RenderType.cutout());
	}
}
