...
public class D27Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_27.get(), renderType -> renderType == RenderType.cutout());
	}
}
