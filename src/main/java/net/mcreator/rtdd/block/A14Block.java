...
import net.mcreator.rtdd.procedures.A14tProcedure;
...
public class A14Block extends FlowerBlock implements BonemealableBlock {
	public A14Block() {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, Random random) {
		...
		A14tProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.A_14.get(), renderType -> renderType == RenderType.cutout());
	}
}
