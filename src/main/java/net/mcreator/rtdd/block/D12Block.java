...
public class D12Block extends Block implements SimpleWaterloggedBlock {
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		return switch (state.getValue(AXIS)) {
			case X -> box(0, 0, 0, 3, 16, 16);
			case Y -> box(0, 0, 0, 16, 3, 16);
			case Z -> box(0, 0, 13, 16, 16, 16);
		};
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_12.get(), renderType -> renderType == RenderType.cutout());
	}
}
