...
public class D61Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_61.get(), renderType -> renderType == RenderType.cutout());
	}
}
