...
public class A21Block extends FlowerBlock implements BonemealableBlock {
	public A21Block() {
		super(MobEffects.MOVEMENT_SPEED, 2000, BlockBehaviour.Properties.of(Material.PLANT).sound(SoundType.GRASS).instabreak().noCollission());
	}
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(RtddModItems.A_12.get(), 5));
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.A_21.get(), renderType -> renderType == RenderType.cutout());
	}
}
