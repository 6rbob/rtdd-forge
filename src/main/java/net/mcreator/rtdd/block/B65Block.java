...
import net.mcreator.rtdd.procedures.Wang0Procedure;
...
public class B65Block extends Block {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		Wang0Procedure.execute(world, x, y, z, entity);
		return InteractionResult.SUCCESS;
	}

	@OnlyIn(Dist.CLIENT)
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.B_65.get(), renderType -> renderType == RenderType.cutoutMipped());
	}
}
