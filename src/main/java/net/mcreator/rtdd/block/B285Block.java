...
import net.mcreator.rtdd.procedures.B283FProcedure;
import net.mcreator.rtdd.init.RtddModBlocks;

import java.util.List;
import java.util.Collections;

public class B285Block extends Block implements SimpleWaterloggedBlock {
	...
	public boolean canSurvive(BlockState blockstate, LevelReader worldIn, BlockPos pos) {
		if (worldIn instanceof LevelAccessor world) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			return B283FProcedure.execute(world, x, y, z);
		}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.B_285.get(), renderType -> renderType == RenderType.cutout());
	}
}
