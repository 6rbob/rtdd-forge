...
public class D33Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_33.get(), renderType -> renderType == RenderType.cutout());
	}
}
