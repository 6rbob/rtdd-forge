...
public class D41Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_41.get(), renderType -> renderType == RenderType.cutout());
	}
}
