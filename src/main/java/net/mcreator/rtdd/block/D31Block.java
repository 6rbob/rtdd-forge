...
public class D31Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_31.get(), renderType -> renderType == RenderType.cutout());
	}
}
