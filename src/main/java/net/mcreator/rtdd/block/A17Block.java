...
import net.mcreator.rtdd.procedures.A17tProcedure;
...
public class A17Block extends FlowerBlock implements BonemealableBlock {
	public A17Block() {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, Random random) {
		...
		A17tProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.A_17.get(), renderType -> renderType == RenderType.cutout());
	}
}
