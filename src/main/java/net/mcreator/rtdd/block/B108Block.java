...
import net.mcreator.rtdd.procedures.CdProcedure;
import net.mcreator.rtdd.init.RtddModBlocks;

import java.util.List;
import java.util.Collections;

public class B108Block extends Block {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		CdProcedure.execute(world, x, y, z, entity);
		return InteractionResult.SUCCESS;
	}

	@OnlyIn(Dist.CLIENT)
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.B_108.get(), renderType -> renderType == RenderType.cutout());
	}
}
