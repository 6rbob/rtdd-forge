...
public class LudengBlock extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.LUDENG.get(), renderType -> renderType == RenderType.cutout());
	}
}
