...
public class D3Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_3.get(), renderType -> renderType == RenderType.cutoutMipped());
	}
}
