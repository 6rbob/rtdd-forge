...
public class D30Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_30.get(), renderType -> renderType == RenderType.cutout());
	}
}
