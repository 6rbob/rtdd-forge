...
public class D11Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_11.get(), renderType -> renderType == RenderType.cutout());
	}
}
