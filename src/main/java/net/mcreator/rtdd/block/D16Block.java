...
public class D16Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_16.get(), renderType -> renderType == RenderType.cutout());
	}
}
