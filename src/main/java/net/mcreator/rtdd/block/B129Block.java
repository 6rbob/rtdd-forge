...
import net.mcreator.rtdd.procedures.BiaobenProcedure;
import net.mcreator.rtdd.init.RtddModBlocks;

import java.util.List;
import java.util.Collections;

public class B129Block extends Block {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		BiaobenProcedure.execute(world, x, y, z, entity);
		return InteractionResult.SUCCESS;
	}

	@OnlyIn(Dist.CLIENT)
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.B_129.get(), renderType -> renderType == RenderType.cutoutMipped());
	}
}
