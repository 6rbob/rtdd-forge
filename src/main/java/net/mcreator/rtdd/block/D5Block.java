...
public class D5Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_5.get(), renderType -> renderType == RenderType.cutoutMipped());
	}
}
