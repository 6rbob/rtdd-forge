...
public class D13Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_13.get(), renderType -> renderType == RenderType.cutout());
	}
}
