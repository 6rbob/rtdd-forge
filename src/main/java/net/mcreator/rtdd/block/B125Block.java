...
public class B125Block extends Block {
	public B125Block() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.B_125.get(), renderType -> renderType == RenderType.cutout());
	}
}
