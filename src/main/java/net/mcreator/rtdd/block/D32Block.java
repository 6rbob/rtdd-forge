...
public class D32Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_32.get(), renderType -> renderType == RenderType.cutout());
	}
}
