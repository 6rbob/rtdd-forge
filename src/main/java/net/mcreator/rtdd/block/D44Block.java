...
public class D44Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_44.get(), renderType -> renderType == RenderType.cutout());
	}
}
