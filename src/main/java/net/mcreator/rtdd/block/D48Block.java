...
public class D48Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_48.get(), renderType -> renderType == RenderType.cutout());
	}
}
