...
public class B81BlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public B81BlockEntity(BlockPos position, BlockState state) {
		super(RtddModBlockEntities.B_81.get(), position, state);
	}
