...
public class D4Block extends Block implements SimpleWaterloggedBlock {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(RtddModBlocks.D_4.get(), renderType -> renderType == RenderType.cutoutMipped());
	}
}
